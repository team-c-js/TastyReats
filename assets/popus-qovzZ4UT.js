import{i as p,a as c}from"./vendor-Dj3mOgk7.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function r(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=r(o);fetch(o.href,s)}})();const g=document.querySelector(".mobile-menu"),y=document.querySelector(".burger-menu"),h=document.querySelector("#mobile-close");y.addEventListener("click",t=>{t.preventDefault(),g.style.display="flex"});h.addEventListener("click",t=>{t.preventDefault(),g.style.display="none"});document.addEventListener("DOMContentLoaded",()=>{const t=document.querySelectorAll(".input-switcher"),e=localStorage.getItem("theme");if(e){const r=e==="dark";r?document.body.classList.add("dark-theme"):document.body.classList.remove("dark-theme"),t.forEach(a=>{a.checked=r})}t.forEach(r=>{r.addEventListener("change",()=>{const a=r.checked;a?(document.body.classList.add("dark-theme"),localStorage.setItem("theme","dark")):(document.body.classList.remove("dark-theme"),localStorage.setItem("theme","light")),t.forEach(o=>{o.checked=a})})})});const f=document.getElementById("scrollToTopBtn");window.addEventListener("scroll",()=>{window.scrollY>300?f.style.display="block":f.style.display="none"});f.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});const n={BASE_URL:"https://tasty-treats-backend.p.goit.global/api",ENDPOINTS:{POPULAR:"/recipes/popular",RECIPE_DETAIL:"/recipes/",ORDERS:"/orders/add/"}},u=(t,e="")=>{console.error(`[${e}] Hata:`,t);const r=document.querySelector(".error-message");return r&&(r.textContent=`Veri yüklenirken hata oluştu: ${t.message}`,r.style.display="block"),null},d={async getFood(){try{return(await c.get(`${n.BASE_URL}${n.ENDPOINTS.POPULAR}`)).data}catch(t){return u(t,"getPopularRecipes")}},async getRecipeDetail(t){try{return(await c.get(`${n.BASE_URL}${n.ENDPOINTS.RECIPE_DETAIL}${t}`)).data}catch(e){return u(e,"getRecipeDetail")}},async createOrder(t){try{return(await c.post(`${n.BASE_URL}${n.ENDPOINTS.ORDERS}`,t)).data}catch(e){return u(e,"createOrder")}},async submitRating(t){try{return console.log(t.rating),console.log(t.email),(await c.patch(`${n.BASE_URL}/recipes/${t.recipeId}/rating`,{rate:t.rating,email:t.email})).data}catch(e){return u(e,"submitRating")}}},m={currentRecipeId:null,async openPopup(t,e){this.currentRecipeId=e;const r=document.querySelector(".popup");r.classList.remove("popup-food","popup-raiting","popup-order"),r.classList.add(`${t}`),r.style.display="block",document.body.style.overflow="hidden",this.resetPopupContent(),t==="popup-food"?await this.fillPopupContent(e):t==="popup-order"?(await this.fillPopupOrder(e),this.setupOrderFormListener()):t==="popup-raiting"&&(await this.fillRatingPopup(e),this.setupRatingListener())},resetPopupContent(){const t=document.querySelector(".popup-content");t.innerHTML=""},closePopup(){const t=document.querySelector(".popup-close"),e=document.querySelector(".popup");function r(){const a=document.querySelector(".popup-video");e.style.display="none",e.className="popup",document.body.style.overflow="auto",a.innerHTML=""}t.addEventListener("click",a=>{a.preventDefault(),r()}),document.addEventListener("keydown",a=>{a.key==="Escape"&&r()})},async fillPopupContent(t){try{const e=await d.getRecipeDetail(t);if(!e)return;const r=document.querySelector(".popup-content");r.innerHTML="";const a=new URL(e.youtube).searchParams.get("v"),s=(JSON.parse(localStorage.getItem("favoriteFoods"))||[]).includes(t),i=s?"Remove To Favorite":"Add to Favorite";r.innerHTML=`
